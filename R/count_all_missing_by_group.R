...
#'
#' @examples
#' # Compute number of missing values in airquality dataset grouped by Month
#' count_all_missing_by_group(airquality, Month)
#'
#' # This example has the same output as the last example, but uses pipe
#' airquality |> count_all_missing_by_group(Month)
#'
#' # The optional .groups argument keeps the output grouped by the grouping column
